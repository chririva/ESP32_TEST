...
#define MAIN_BLE_CONFIG_H_
	...
	#define TAG "EGTeachersButton_Gatto" // Prepended to all logging output
	...
	//messe io
	#define EG_VERSION_MAJOR 0x00
	#define EG_VERSION_MINOR 0x09
	#define EG_VERSION_REVISION 0x03
